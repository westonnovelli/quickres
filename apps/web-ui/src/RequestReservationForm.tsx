...
const RequestReservationForm: React.FC<Props> = ({ eventId }) => {
	...
	return (
		...
		>
			...
			<button
				type="submit"
				disabled={isSubmitting || !form.state.isValid || reservationMutation.isPending}
				className="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
			>
				{isSubmitting || reservationMutation.isPending ? "Requesting..." : "Request Reservation"}
			</button>
		</form>
	);
};
